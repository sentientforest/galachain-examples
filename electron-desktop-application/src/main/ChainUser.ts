...
// todo: move this to chain-api in the sdk
// some modern bundlers insist on fabric dependencies being 
// present in order to use any import from chain-client
// then crash on fabric related errors 
/**
